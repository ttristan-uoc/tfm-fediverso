...
if __name__ == "__main__":
    ...
    analyzer.visualize_adjacency_matrix(output_file="plots/adjacency_matrix.png", top_instances=None,
    ...
    analyzer.calculate_and_save_centrality_metrics(output_file="data/centrality_metrics.csv")
    analyzer.top_metrics(metrics_file='data/centrality_metrics.csv', top_n=20)
    analyzer.plot_centrality_distributions(metrics_file='data/centrality_metrics.csv', output_dir='plots/')
    analyzer.plot_betweenness_degree_correlation(metrics_file='data/centrality_metrics.csv', output_file='plots/betweenness_degree_correlation.png')
